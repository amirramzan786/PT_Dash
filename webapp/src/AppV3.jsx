...
import {
  ...
  loadExerciseCatalog, loadWorkouts, saveProfile, saveWeight, saveWorkoutSession, updateAccount, uploadAvatar,
} from './lib/steelApi'
import './app-v2.css'
import './settings.css'
import './v3.css'
...
function LogWorkoutPage({ onCancel, onStart }) {
...
export default function AppV3({ user, onSignOut }) {
  ...
  return <div className="steel-app">
    <main className="steel-screen">
      ...
      {tab === 'Plan' && (customLogOpen ? <LogWorkoutPage onCancel={() => setCustomLogOpen(false)} onStart={(workout) => { setCustomLogOpen(false); openWorkout(workout) }}/> : <PlanPage workouts={workouts} openWorkout={openWorkout} onLogWorkout={() => setCustomLogOpen(true)}/>)}
