...
function TodayMealPlan({ mealOrder, recipes, selectedChoices, setSelectedChoices, portions, setPortions, plannedLogs, logBusy, onEdit, onLog, onUnlog, onFindFood, editor }) {
