...
import { buildWeeklyNutritionAdherence, buildWeightTrend, startOfWeek } from './lib/progressSignals'
import './app-v2.css'
import './settings.css'
import './v3.css'
...
function NutritionPage({ preferences, navigateToTab, userId }) {
  ...
  const calorieProgress = Math.min(100, Math.round((loggedCalories / Math.max(1, target.calories)) * 100))
  ...
  return <div className={`page-stack nutrition-page nutrition-page-${nutritionView}`}>
    ...
    {nutritionView === 'plan' && <DietPlanOverview mealOrder={mealOrder} recipes={assignedRecipes} dietary={dietary} target={target} onOpenDiary={() => setNutritionView('diary')}/>}
