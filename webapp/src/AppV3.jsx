...
function PreferencesForm({ preferences, setPreferences, toggleEquipment, onSubmit, saving, planChangeStatus, onRequestPlanReview }) {
  return <form className="steel-card preferences-form" onSubmit={onSubmit}>
    ...
    <label><span>Weight units</span><select value={preferences.units} onChange={e=>setPreferences({...preferences, units:e.target.value})}><option value="lb">Pounds (lb)</option><option value="kg">Kilograms (kg)</option></select></label>
