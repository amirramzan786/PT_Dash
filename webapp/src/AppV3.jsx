...
import {
  Activity, ArrowLeft, ArrowRight, Camera, Check, ChevronRight, Dumbbell, Flame,
  Footprints, Home, LineChart, LogOut, Mail, Play, RotateCcw, Save, Scale,
  ShieldCheck, Target, Trash2, Trophy, UserRound, Watch,
} from 'lucide-react'
import {
  ...
  return <div className="steel-app">
    <main className="steel-screen">
      <header className="v2-topbar">
        ...
        <button className={`account-button ${tab === 'Settings' ? 'active' : ''}`} onClick={() => setTab('Settings')}><Avatar url={avatarUrl} size={32} /><span className="account-copy"><strong>{accountName}</strong><small>Profile</small></span><ChevronRight size={15} /></button>
      </header>
