...
import {
  ...
  getNutritionPlan, getWeeklyActivitySummary, loadExerciseCatalog, loadWorkouts, resetOnboarding, saveCustomWorkout, saveMealLog, saveMealPlanItem, saveProfile, saveWeight, saveWeeklyCheckin as saveWeeklyCheckinRecord, saveWorkoutSession, updateAccount, updateCustomWorkout, uploadAvatar, uploadCheckinMedia,
} from './lib/steelApi'
import './app-v2.css'
import './settings.css'
import './v3.css'
...
function SettingsPage({ user, onSignOut, closeSettings, accountName, avatarUrl, profileName, setProfileName, profileEmail, setProfileEmail, profilePhone, setProfilePhone, saveAccount, handleAvatar, avatarBusy, currentPassword, setCurrentPassword, newPassword, setNewPassword, confirmPassword, setConfirmPassword, savePassword, saving, preferences, setPreferences, toggleEquipment, savePreferences, openSupportPanel, onResetOnboarding }) {
  ...
  const ownerEmail = 'ramzan_amir@hotmail.com'
  const showAdminControls = user.email?.toLowerCase() === ownerEmail
