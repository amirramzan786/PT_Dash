...
test('current-main Home, recovery and food-diary integration contracts remain present', async () => {
  ...
  assert.match(app, /<HealthIntegrations connections=\{activityConnections\} onConnect=\{onConnectActivityProvider\} onDisconnect=\{onDisconnectActivityProvider\} onDeleteImportedData=\{onDeleteActivityProviderData\}\/>/)
  assert.match(app, /saveActivityConnection/)
  assert.match(app, /onConnectActivityProvider=\{handleConnectActivityProvider\}/)
